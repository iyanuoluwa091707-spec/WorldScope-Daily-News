...
import { Article, CategoryInfo, CommentItem, LiveUpdate } from './types';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-black font-worldscope-sans selection:bg-black selection:text-white">
      ...
      {/* BBC Newsletters Signup Modal (Matches 8.PNG and 9.PNG) */}
      <NewslettersModal
      ...
      {/* BBC Sign In & Registration Modal (Matches 11.PNG) */}
      <AuthModal
