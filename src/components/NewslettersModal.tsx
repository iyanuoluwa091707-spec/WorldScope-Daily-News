...
const NEWSLETTERS: NewsletterItem[] = [
  ...
  },
  {
    ...
    description:
      'Decode the biggest developments in global technology and learn how to live a better digital life, guided by WorldScope tech journalists.',
    themeColor: '#0284c7',
    headerBg: 'bg-[#0284c7]',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'Dive into the biggest Premier League stories with smart analysis, expert insight and exclusive interviews.',
    themeColor: '#16a34a',
    headerBg: 'bg-[#15803d]',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'Gain the leading edge with global insights for the boardroom and beyond, direct from London and New York.',
    themeColor: '#005A9C',
    headerBg: 'bg-[#005A9C]',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'Curated reviews, arts coverage, and literary highlights picked by WorldScope Culture correspondents.',
    themeColor: '#9B1B59',
    headerBg: 'bg-[#9B1B59]',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'Practical wellbeing advice, medical science breakthroughs, and NHS analysis.',
    themeColor: '#007F7F',
    headerBg: 'bg-[#007F7F]',
    imageUrl:
...
export const NewslettersModal: React.FC<NewslettersModalProps> = ({
  ...
  /*
   * Reset the selected newsletters whenever the modal opens
   * or the initial newsletter changes.
   */
  useEffect(() => {
    if (isOpen) {
  ...
  const handleSubscribe = (e: React.FormEvent) => {
    ...
    if (onSuccessToast) {
      onSuccessToast(
        `Subscribed to ${selectedIds.length} WorldScope newsletter${
        ...
        <div className="p-4 sm:p-8 max-h-[78vh] overflow-y-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-700 font-normal leading-relaxed max-w-2xl">
              Get the latest news, personalised insights,
              and must-read stories from WorldScope Daily
              straight to your inbox with our free
              newsletters.
            </p>
          </div>
          ...
          <div className="bg-[#e9ecef] border border-gray-300 p-4 sm:p-6">
            ...
            <h4 className="text-lg sm:text-xl font-bold font-serif text-black mb-1">
              You've selected {selectedIds.length}{' '}
              newsletter
              {selectedIds.length === 1 ? '' : 's'}
            </h4>
            ...
            {submitted ? (
              ...
              >
                ...
                <p className="text-[11px] text-gray-600 leading-normal pt-2">
                  By continuing you are creating a
                  WorldScope Daily account, if you don't
                  already have one, and you accept our{' '}
                  <strong className="text-black underline cursor-pointer">
                    Terms of Use
                  </strong>
